...
export const DialogStyleMap = defineStyleMap({
  ...
  slots: {
    ...
    content: [
      'rounded-md','flex','flex-col','min-h-0','gap-8','items-center','p-40','relative',
      'box-border','z-10','outline-none','text-color-content-default',
      'pointer-events-auto','bg-background-modal-dark','shadow-(--shadow-shadows-shadow-6)',
      'h-[min(650px,calc(100vh-40px))]','overflow-visible',
