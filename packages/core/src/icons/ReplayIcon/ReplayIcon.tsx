// packages/core/src/icons/ReplayIcon/ReplayIcon.tsx
// Generated by AI (DoXYZ agents). Do not edit directly.
// Summary: ReplayIcon renders a close glyph SVG supporting decorative or labeled usage with optional title and color props

import * as React from 'react';

export interface ReplayIconProps extends React.SVGAttributes<SVGSVGElement> {
  decorative?: boolean;
  title?: string;
  titleId?: string;
  color?: string;
...
type ReplayIconElement = SVGSVGElement;

export const ReplayIcon = React.forwardRef<ReplayIconElement, ReplayIconProps>(
  (
    {
      decorative = true,
      width = '20px',
