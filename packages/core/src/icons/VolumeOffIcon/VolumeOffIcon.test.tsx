// packages/core/src/icons/VolumeOffIcon/VolumeOffIcon.test.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Confirms VolumeOffIcon decorative defaults, labeled role=img support, color prop passthrough, className merge, and generated title ids.
...
describe('VolumeOffIcon', () => {
  it('defaults to decorative and sets aria-hidden="true"', () => {
    render(<VolumeOffIcon data-testid="icon" />);
    expect(screen.getByTestId('icon')).toHaveAttribute('aria-hidden', 'true');
  });

  it('renders non-decorative icons with title as role="img" and aria-labelledby', () => {
    render(<VolumeOffIcon decorative={false} title="Dismiss" titleId="close-icon" />);
  ...
  it('applies the color prop to the fill attribute', () => {
    render(<VolumeOffIcon data-testid="icon" color="#123456" />);
    expect(screen.getByTestId('icon')).toHaveAttribute('fill', '#123456');
  });

  it('merges className onto the svg element', () => {
    render(<VolumeOffIcon data-testid="icon" className="custom-class" />);
  ...
  it('generates a title id when non-decorative with title and no titleId', () => {
    render(<VolumeOffIcon decorative={false} title="Dismiss" />);
