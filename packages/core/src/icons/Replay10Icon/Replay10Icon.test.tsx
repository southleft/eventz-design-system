// packages/core/src/icons/Replay10Icon/Replay10Icon.test.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Confirms Replay10Icon decorative defaults, labeled role=img support, color prop passthrough, className merge, and generated title ids.

import { render, screen } from '@testing-library/react';
import { Replay10Icon } from './Replay10Icon';

describe('Replay10Icon', () => {
  it('defaults to decorative and sets aria-hidden="true"', () => {
    render(<Replay10Icon data-testid="icon" />);
    expect(screen.getByTestId('icon')).toHaveAttribute('aria-hidden', 'true');
  });

  it('renders non-decorative icons with title as role="img" and aria-labelledby', () => {
    render(<Replay10Icon decorative={false} title="Dismiss" titleId="close-icon" />);
  ...
  it('applies the color prop to the fill attribute', () => {
    render(<Replay10Icon data-testid="icon" color="#123456" />);
    expect(screen.getByTestId('icon')).toHaveAttribute('fill', '#123456');
  });

  it('merges className onto the svg element', () => {
    render(<Replay10Icon data-testid="icon" className="custom-class" />);
  ...
  it('generates a title id when non-decorative with title and no titleId', () => {
    render(<Replay10Icon decorative={false} title="Dismiss" />);
