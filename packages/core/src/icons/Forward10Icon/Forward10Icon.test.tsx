// packages/core/src/icons/Forward10Icon/Forward10Icon.test.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Confirms Forward10Icon decorative defaults, labeled role=img support, color prop passthrough, className merge, and generated title ids.

import { render, screen } from '@testing-library/react';
import { Forward10Icon } from './Forward10Icon';

describe('Forward10Icon', () => {
  it('defaults to decorative and sets aria-hidden="true"', () => {
    render(<Forward10Icon data-testid="icon" />);
    expect(screen.getByTestId('icon')).toHaveAttribute('aria-hidden', 'true');
  });

  it('renders non-decorative icons with title as role="img" and aria-labelledby', () => {
    render(<Forward10Icon decorative={false} title="Dismiss" titleId="close-icon" />);
  ...
  it('applies the color prop to the fill attribute', () => {
    render(<Forward10Icon data-testid="icon" color="#123456" />);
    expect(screen.getByTestId('icon')).toHaveAttribute('fill', '#123456');
  });

  it('merges className onto the svg element', () => {
    render(<Forward10Icon data-testid="icon" className="custom-class" />);
  ...
  it('generates a title id when non-decorative with title and no titleId', () => {
    render(<Forward10Icon decorative={false} title="Dismiss" />);
