// packages/core/src/icons/ShareIcon/ShareIcon.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: ShareIcon renders a share glyph SVG supporting decorative or labeled usage with optional title and color props

import * as React from 'react';

export interface ShareIconProps extends React.SVGAttributes<SVGSVGElement> {
  decorative?: boolean;
  title?: string;
  titleId?: string;
  color?: string;
...
type ShareIconElement = SVGSVGElement;

export const ShareIcon = React.forwardRef<ShareIconElement, ShareIconProps>(
  (
    {
      decorative = true,
      width = '20px',
