// packages/core/src/icons/VolumeUpIcon/VolumeUpIcon.test.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Confirms VolumeUpIcon decorative defaults, labeled role=img support, color prop passthrough, className merge, and generated title ids.
...
describe('VolumeUpIcon', () => {
  it('defaults to decorative and sets aria-hidden="true"', () => {
    render(<VolumeUpIcon data-testid="icon" />);
    expect(screen.getByTestId('icon')).toHaveAttribute('aria-hidden', 'true');
  });

  it('renders non-decorative icons with title as role="img" and aria-labelledby', () => {
    render(<VolumeUpIcon decorative={false} title="Dismiss" titleId="close-icon" />);
  ...
  it('applies the color prop to the fill attribute', () => {
    render(<VolumeUpIcon data-testid="icon" color="#123456" />);
    expect(screen.getByTestId('icon')).toHaveAttribute('fill', '#123456');
  });

  it('merges className onto the svg element', () => {
    render(<VolumeUpIcon data-testid="icon" className="custom-class" />);
  ...
  it('generates a title id when non-decorative with title and no titleId', () => {
    render(<VolumeUpIcon decorative={false} title="Dismiss" />);
