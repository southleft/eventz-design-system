// packages/core/src/components/server/ContentCard/ContentCard.test.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Exercises ContentCard media, badge, label metadata, focusable or link modes, aria-label handling, slot order, and layout token application.
