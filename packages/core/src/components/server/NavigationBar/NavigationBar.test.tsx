// packages/core/src/components/server/NavigationBar/NavigationBar.test.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Confirms NavigationBar navigation landmark naming, link rendering, current item aria-current, fixed styling, responsive list behavior, and logo/mobile slots.
