// packages/core/src/components/server/ActionCard/ActionCard.test.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Ensures ActionCard renders slot order, focusable state, media and badge combinations, title handling, and control overlay with focus ring tokens.
