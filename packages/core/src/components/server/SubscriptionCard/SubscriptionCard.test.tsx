// packages/core/src/components/server/SubscriptionCard/SubscriptionCard.test.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Validates SubscriptionCard terms display, inactive subtitle, active detail rows, cancel link or slot overrides, and surface token changes.
