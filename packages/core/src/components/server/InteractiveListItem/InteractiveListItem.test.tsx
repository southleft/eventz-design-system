// packages/core/src/components/server/InteractiveListItem/InteractiveListItem.test.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Tests InteractiveListItem button or link rendering, removable layout toggles, media placeholders, data attributes, text visibility, and focus ring tokens.
