// packages/core/src/components/server/MediaCard/MediaCard.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: MediaCard arranges optional image, subtitle, labels, and control slot with hover transitions and lazy image handling.
