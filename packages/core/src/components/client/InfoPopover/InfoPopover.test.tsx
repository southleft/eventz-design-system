// packages/core/src/components/client/InfoPopover/InfoPopover.test.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Ensures InfoPopover trigger button semantics, opens content on click, closes on Escape with focus restore, fires onOpenChange, applies content id, and marks icon decorative.
