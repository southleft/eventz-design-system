...
// Summary: Multi-select Combobox with chips; toggles via click/Space/Enter/Escape; controlled or uncontrolled; outside-click close; start/end icon slots; clear-all; disabled guards.
