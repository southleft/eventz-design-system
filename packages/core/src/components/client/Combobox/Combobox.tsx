...
// packages/core/src/components/client/Combobox/Combobox.tsx
// Generated by AI (DoXYZ agents). Do not edit directly.
// Summary: Combobox with pointer interactions and minimal keyboard toggles (Space/Enter/Escape). Supports controlled/uncontrolled open, selection add/remove/clear‑all, outside‑click close, and predictable focus (keyboard closes keep focus on input; pointer closes keep focus where clicked).
