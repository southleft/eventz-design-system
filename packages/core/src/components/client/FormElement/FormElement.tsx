...
// packages/core/src/components/client/FormElement/FormElement.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: FormElement shells inputs with labeled row, optional InfoPopover, hint/error messaging, and Slot-based control attribute injection.
