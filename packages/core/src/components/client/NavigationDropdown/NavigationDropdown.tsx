...
// packages/core/src/components/client/NavigationDropdown/NavigationDropdown.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: NavigationDropdown toggles a full-screen popover menu using an IconButton trigger, nav landmark labeling, and MenuItem list.
