...
// packages/core/src/components/client/Accordion/Accordion.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Accordion that renders a single collapsible item with optional image, intro text, emphasis styling, and Radix toggle controls.
