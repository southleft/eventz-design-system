...
// packages/core/src/components/client/Select/Select.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Select wraps Radix select with Input trigger, manages controlled/uncontrolled value, renders MenuItem options, and forwards disabled props.
