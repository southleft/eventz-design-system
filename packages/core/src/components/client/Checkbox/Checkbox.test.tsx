// packages/core/src/components/client/Checkbox/Checkbox.test.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Ensures Checkbox validates label, merges aria-describedby with hints, toggles indicator, wires hint/error ids, respects disabled/required props, submits value, and keeps focus ring.
