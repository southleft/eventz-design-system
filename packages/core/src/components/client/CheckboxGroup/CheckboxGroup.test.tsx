// packages/core/src/components/client/CheckboxGroup/CheckboxGroup.test.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Covers CheckboxGroup accessible naming, aria-describedby with hint and error, choice toggling callbacks, info popover a11y, error icon rendering, and deterministic choice ids.
