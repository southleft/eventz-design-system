...
// packages/core/src/components/client/Alert/Alert.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Alert with variant gradients, optional leading icon, dismiss button, text link support, and status vs alert roles.
