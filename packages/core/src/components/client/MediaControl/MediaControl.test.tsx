// packages/core/src/components/client/MediaControl/MediaControl.test.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Validates MediaControl button aria labels, icon toggling, callback order, controlled versus uncontrolled state changes, keyboard interaction, data-state, and label overrides.
