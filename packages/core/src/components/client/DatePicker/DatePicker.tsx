...
// packages/core/src/components/client/DatePicker/DatePicker.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Date range picker wrapping RSuite with Input trigger, controlled/uncontrolled open and value, responsive single-calendar mode, and mobile toolbar injection.
