// packages/core/src/components/client/MenuItem/MenuItem.test.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Checks MenuItem button or link semantics, aria labeling, simple versus complex media slots, media icon precedence, and selection data attributes.
...
describe('MenuItem', () => {
  ...
  it('renders a link when href is provided', () => {
    ...
    expect(screen.getByRole('link', { name: 'Sample option' })).toHaveAttribute('href', '/account');
  });
  ...
  it('omits the alt attribute when imgAlt, option, and ariaLabel are all missing (complex)', () => {
    render(<MenuItem type="complex" imgSrc="https://picsum.photos/seed/eventz/160/160" />);
