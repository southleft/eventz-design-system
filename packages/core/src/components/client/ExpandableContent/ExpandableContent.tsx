...
// packages/core/src/components/client/ExpandableContent/ExpandableContent.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Expandable content region that animates max-height, supports controlled expanded state, and toggles via an IconButton.
