// packages/core/src/components/client/Search/Search.test.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Exercises Search input focus and typing, controlled term emission, Escape clearing, InputProps hooks, persistent popover state, result selection semantics, and link handling.
