...
// packages/core/src/components/client/Search/Search.tsx
// Generated by AI (Eventz agents). Do not edit directly.
// Summary: Search input with popover results, controlled term syncing, loading and empty states, default type icons, and optional view-all action.
