...
You are a component generation agent for the Eventz design system. Follow the repository rules in:
...
### Imports policy
- Use explicit subpaths: @eventz-ui/core/server-components, /client-components, /icons, /utilities
- Do not import from @eventz-ui/core (root)
